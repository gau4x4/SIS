...
<div class="university-bulletin-wrapper">
	<div class="university-bulletin">
    	<div class="bulletin-link">
            <a href="IT.jsp" title="College News">AS&H DEPTT. NOTICE</a>
        </div>
...
<div class="dnnPEMContNotitle"><div id="dnn_ctr7503_ContentPane" class="dnnPEMContNotitleBody"><!-- Start_Module_7503 --><div id="dnn_ctr7503_ModuleContent" class="DNNModuleContent ModDNNHTMLC">
    ...
    <li><span>NOTICE NOTICE NOTICE NOTICE NOTICE NOTICE NOTICE</span><a href=""></a>
    </li>
...
<img id="dnn_ctr5600_Viewnewsforview_lstContent_ImagePreview_0" title="IMSEC" src="Images/08-50-52.jpg" alt="SIR" style="height:100px;width:160px;" />
    ...
    <h2 class="post-heading"><a id="dnn_ctr5600_Viewnewsforview_lstContent_hpTitle_0" title="IMSEC" >NOTICE</a></h2>
	<h3 class="date">
<span id="dnn_ctr5600_Viewnewsforview_lstContent_lblDate_0">NOTICE</span> <span id="dnn_ctr5600_Viewnewsforview_lstContent_lblMonth_0"></span><span id="dnn_ctr5600_Viewnewsforview_lstContent_lblYear_0"> </span>
</h3>
<p>

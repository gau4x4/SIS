...
<html>
    <head>
        ...
        <title>IT DEPARTMENT EVENTS</title>
...
<div class="university-bulletin-wrapper">
	<div class="university-bulletin">
    	<div class="bulletin-link">
            <a href="IT.jsp" title="College News">IT DEPTT. EVENTS</a>
        </div>
...
<div class="dnnPEMContNotitle"><div id="dnn_ctr7503_ContentPane" class="dnnPEMContNotitleBody"><!-- Start_Module_7503 --><div id="dnn_ctr7503_ModuleContent" class="DNNModuleContent ModDNNHTMLC">
    ...
    <li><span>WELCOME TO IMSEC EVENTS PORTAL HERE WE CAN FIND- EVENTS OF INFORMATION TECHNOLOGY DEPARTMENT</span><a href=""></a>
    </li>
...
<section>
<h1>---------------------IT--DEPTT.--EVENTS------------------------</h1>
<table id="dnn_ctr5600_Viewnewsforview_lstContent" cellspacing="0" style="width:100%;border-collapse:collapse;">

	<tr><td>
<article>
<figure>
<img id="dnn_ctr5600_Viewnewsforview_lstContent_ImagePreview_0" title="IMSEC" src="Images/08-50-52.jpg" alt="SIR" style="height:100px;width:160px;" />
</figure>
    <h2 class="post-heading"><a id="dnn_ctr5600_Viewnewsforview_lstContent_hpTitle_0" title="IMSEC" >EVENTS</a></h2>
	<h3 class="date">
<span id="dnn_ctr5600_Viewnewsforview_lstContent_lblDate_0">EVENTS</span> <span id="dnn_ctr5600_Viewnewsforview_lstContent_lblMonth_0"></span><span id="dnn_ctr5600_Viewnewsforview_lstContent_lblYear_0"> </span>
</h3>
<p>

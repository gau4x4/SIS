...
<html>
    <head>
        ...
        <title>IT DEPARTMENT GEMS</title>
...
<div class="university-bulletin-wrapper">
	<div class="university-bulletin">
    	<div class="bulletin-link">
            <a href="IT.jsp" title="College News">IT DEPTT. GEMS</a>
        </div>
...
<img id="dnn_ctr5600_Viewnewsforview_lstContent_ImagePreview_0" title="IMSEC" src="Images/08-50-52.jpg" alt="SIR" style="height:100px;width:160px;" />
    ...
    <h2 class="post-heading"><a id="dnn_ctr5600_Viewnewsforview_lstContent_hpTitle_0" title="IMSEC" >NAME</a></h2>
	<h3 class="date">
<span id="dnn_ctr5600_Viewnewsforview_lstContent_lblDate_0"></span> YEAR<span id="dnn_ctr5600_Viewnewsforview_lstContent_lblMonth_0"></span><span id="dnn_ctr5600_Viewnewsforview_lstContent_lblYear_0"> </span>
</h3>
<p>

...
<form class="formoid-solid-green" style="background-color:#ffffff;font-size:15px;font-family:'Courier New',Courier,monospace;color:#34495E;max-width:500PX;min-width:150px" method="post"><div class="title"><h2>CHANGE PASSWORD</h2></div>
	...
	<div class="element-password<?frmd_add_class("password2")?>" title="PASSWORD"><label class="title"><span class="required">*</span></label><div class="item-cont"><input class="large" type="password" name="password2" value="" required="required" placeholder="PASSWORD"/><span class="icon-place"></span></div></div>
